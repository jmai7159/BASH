...
#Task 7 Check to see if cat is in my array let the user know
echo -e "Task 7\n"
catFlag=0
for i in ${!myArray[*]};
do
...
#Task 8 Get the name of a Marvel Character from the user and pass it to random insert function
echo -e "Task 8\n"
